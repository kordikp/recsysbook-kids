...
class PBook {
  ...
  _getHighlights(block) {
    ...
    const HIGHLIGHTS = {
      ...
      'ch2-interactions': ['Explicit (ratings, likes) = what you SAY. Implicit (watch time, skips) = what you DO', 'Implicit wins: every interaction generates data, no bias, 100× more coverage than ratings', 'Netflix dropped 5-star ratings for thumbs up/down. YouTube uses watch time, not likes. Actions beat opinions'],
